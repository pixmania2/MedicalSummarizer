...
num_reports = 100000
with open("synthetic_medical_reports_1l.jsonl", "w") as out:
    for _ in range(num_reports):
        json.dump(generate_report(), out)
        out.write("\n")

print(f"Synthetic dataset of {num_reports} reports generated successfully.")
